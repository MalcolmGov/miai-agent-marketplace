...
const CATEGORY_PATTERNS: { id: string; re: RegExp }[] = [
  ...
  { id: "Cybersecurity", re: /\b(cyber|security incident|phishing|soc|infosec)\b/i },
  { id: "Energy & utilities", re: /\b(energy operations|renewable|grid|power outage|electric utility)\b/i },
  { id: "Agriculture", re: /\b(farm|agriculture|agri|crop|livestock)\b/i },
  { id: "Media & entertainment", re: /\b(media content|broadcast|entertainment|streaming rights)\b/i },
  ...
  { id: "HR & internal ops", re: /\b(helpdesk|it support|payroll|procurement|executive assistant|recruitment|interview|hr|learning|performance review|l&d)\b/i },
