      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            Lightweight insights — turns, pauses, connector health for this workspace. For tokens,
            spend, and estimated savings see Insights.
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <a href="/insights" className="btn btn-ghost text-sm">
            Insights
          </a>
          <a href="/history" className="btn btn-ghost text-sm">
            History
          </a>
          <a href="/workspace" className="btn btn-ghost text-sm">
            Workspace
          </a>
        </div>
      </div>
