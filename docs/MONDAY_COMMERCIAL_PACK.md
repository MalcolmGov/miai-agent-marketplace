...
**Commercial model:** sell the **Agent Marketplace as a platform** under an **annual license** that includes the **full catalogue — 92 families × 5 market packs = 460 agents**. First-wave **Go-live 18** are the families we stand behind for customer production while cutover completes.

| Component | Amount / split |
|---|---|
| Annual platform license | **$200,000 / year** (~$435 / agent / year) |
...
|---|---|---|
| **Annual platform license** | **$200,000 / year** | Marketplace + full **460** agents day 1 (~$435 / agent / year) |
...
|---|---|---|---|
| 1 | **Product entitlement** | Subset vs **full 460** | **Full catalogue under annual platform license** |
...
| Line | Amount |
|---|---|
| Annual platform license (460 agents) | **$200,000 / year** |
| Monthly support, maintenance & new agent development | **$30,000 / month** |
...
Catalogue claim (safe): **92 families × 5 market packs = 460 catalogue-ready agents** (see `CATALOGUE_READY.md`). Platform rails (SSO, live wallet, Azure) are integration work, not catalogue gaps.

---

## 4. Go-live wave (18 families) — production first wave

These eighteen families are the **first wave we stand behind for customer production**. The **license still covers all 460**.
...
1. Catalogue — **460 agents under platform license**  
...
**Say once:** commercial = annual platform license for all 460; Go-live 18 is the production first wave. SSO and live MIAI wallet are cutover items on their rails.

---

## 8. Commercial close checklist

- [ ] **Annual platform license $200,000** = full 460 agents  
