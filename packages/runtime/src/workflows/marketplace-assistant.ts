...
export async function runMarketplaceAssistantWorkflow(input: {
  ...
  if (/how many agents|220|275|350|410|catalogue size|catalog size|how many.*famil/.test(lower)) {
    return {
      handled: true,
      toolCalls,
      assistantMessage:
        "The marketplace has **82 agent families × 5 market packs (US, EU, Africa, Asia, Oceania) = 410 agents**. Browse the full catalogue on / — tell me your use case and I’ll recommend a fit.",
    };
  }
