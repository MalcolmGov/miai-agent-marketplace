...
export async function runMarketplaceAssistantWorkflow(input: {
  ...
  if (/how many agents|220|275|350|catalogue size|catalog size|how many.*famil/.test(lower)) {
    return {
      handled: true,
      toolCalls,
      assistantMessage:
        "The marketplace has **70 agent families × 5 market packs (US, EU, Africa, Asia, Oceania) = 350 agents**. Browse the full catalogue on / — tell me your use case and I’ll recommend a fit.",
    };
  }
